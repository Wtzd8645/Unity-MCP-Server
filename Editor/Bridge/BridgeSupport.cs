...
namespace Blanketmen.UnityMcp.Bridge.Editor
{
    ...
    {
        public static BridgeToolCallResponse Success(string contentText, object structuredContent)
        {
        ...
        public static BridgeToolCallResponse Error(string message, string status, string toolName)
        {
        ...
        public static BridgeToolCallResponse NotImplemented(string toolName)
        {
            ...
            return Success("Tool '" + toolName + "' is not implemented in Unity bridge yet.", payload);
        }
    }
    ...
    internal static class BridgeJson
    {
        public static T ParseArgs<T>(string rawJson, T defaults) where T : class
        {
            ...
            {
                Debug.LogWarning("[Unity MCP Bridge] Failed to parse arguments JSON: " + ex.Message);
            }
