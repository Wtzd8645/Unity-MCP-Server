...
{
    internal static class GameObjectWriteToolHandlers
    {
        ...
        public static ControlToolCallResponse HandleGameObjectAddComponent(ControlToolCallRequest request)
        {
            ...
            var items = new List<MutationItem>();
            MutationItem item = ControlWriteSupport.BuildGoMutationItem(target, "gameobject_add_component");
        ...
        public static ControlToolCallResponse HandleGameObjectRemoveComponent(ControlToolCallRequest request)
        {
            ...
            var items = new List<MutationItem>();
            MutationItem item = ControlWriteSupport.BuildGoMutationItem(target, "gameobject_remove_component");
            item.componentId = GlobalObjectId.GetGlobalObjectIdSlow(component).ToString();
            item.componentType = component.GetType().FullName ?? component.GetType().Name;
            items.Add(item);
        ...
        public static ControlToolCallResponse HandleGameObjectSetComponentFields(ControlToolCallRequest request)
        {
            ...
            var items = new List<MutationItem>();
            MutationItem item = ControlWriteSupport.BuildGoMutationItem(target, "gameobject_set_component_fields");
            item.componentId = GlobalObjectId.GetGlobalObjectIdSlow(component).ToString();
            item.componentType = component.GetType().FullName ?? component.GetType().Name;
            items.Add(item);
